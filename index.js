...
program
  ...
  program
    ...
    .option('-f|--file-names', 'a txt file with file names to filter on - only returns files listed in this file, excluding extensions')
    .option('-t|--file-types <filetypes>', 'file type extensions to include in the extraction - default is .jpg, .jpeg')
